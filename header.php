...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,900"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
        ...
        <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
            <div class="container">
                <div class="collapse navbar-collapse"
                    ...
                    <a href="account.php"> <img alt="cart" src="public/img/account-white.png" style="width:30px;height:30px;margin-left: 5px"</a>
                </div>
            </div>
        </nav>
    </div>
